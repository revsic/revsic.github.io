...
<div class="bio-layout">
  <div class="row">
    <div class="col-lg-4 mb-5 mb-lg-0">
      <div class="bio-left">
        <h1 class="bio-name">Young Joong Kim</h1>
        <p class="bio-tagline">Master's Student in CSE</p>
        <p class="bio-subtitle">Seoul National University</p>
    ...
    <div class="col-lg-8">
      <div class="bio-section">
        <h3 class="bio-section-title">News</h3>
        <div class="bio-news">
          <div class="bio-news-item">
            <span class="bio-date">2025/08</span>
            <p class="bio-news-text">DARPA AIxCC 3rd Place with <a href="https://theori-io.github.io/aixcc-public/index.html">Team Theori</a>.</p>
          </div>
          <div class="bio-news-item">
            <span class="bio-date">2025/03</span>
            <p class="bio-news-text">Started M.S. program at <a href="https://www.snu.ac.kr/">Seoul National University</a>.</p>
          </div>
        </div>
      </div>
